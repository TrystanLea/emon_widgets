...
<script type="application/javascript">
  ...
  function update()
  {
    ...
    $.ajax({                                      
      url: 'http://server/emoncms2/api/getfeedvalue?apikey=xxxxxxxxxxxxxxxxxxxxxxx&feedid=2',                         
      dataType: 'json',                           
      success: function(data) 
      { 
        power = data*1;
  ...
  ctx.clearRect(0,0,360,575);
    ...
    ctx.fillRect(115,(ypos+5)-(projected_at_power*ppk),130,(projected_at_power*ppk));
    ctx.fillStyle = "#87c03f";
    ctx.fillRect(120,ypos-(projected*ppk),120,(projected*ppk));
    ctx.fillStyle = "#f8a01b";
    ctx.fillRect(125,(ypos-5)-(h-5),110,(h-5));
